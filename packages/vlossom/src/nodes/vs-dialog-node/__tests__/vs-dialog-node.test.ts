...
describe('vs-dialog-node', () => {
    ...
    describe('esc stack store', () => {
        it('mount 되면 esc stack store에 dialog id를 push 한다', () => {
            // given
            const spy = vi.spyOn(store.escStack, 'push');
            const wrapper = mount(VsDialogNode);
        ...
        it('unmount 되면 esc stack store에서 dialog id를 pop 한다', () => {
            // given
            const spy = vi.spyOn(store.escStack, 'pop');
            const wrapper = mount(VsDialogNode);
