...
describe('vs-switch', () => {
    describe('v-model', () => {
        ...
        it('modelValue를 업데이트할 수 있다', async () => {
            ...
            // when
            const target = wrapper.find('[role="switch"]');
    ...
    describe('true / false label', () => {
        it('false-label을 설정할 수 있다', () => {
            ...
            // then
            const label = wrapper.find('[data-value=false]');
        ...
        it('true-label을 설정할 수 있다', async () => {
            ...
            // then
            const label = wrapper.find('[data-value=true]');
            expect(label.isVisible()).toBe(true);
    ...
    describe('focus / blur', () => {
        it('focus 이벤트를 발생시킬 수 있다', async () => {
            ...
            const wrapper: ReturnType<typeof mountComponent> = mount(VsSwitch);
            // when
            await wrapper.find('[role="switch"]').trigger('focus');
            // then
        ...
        it('blur 이벤트를 발생시킬 수 있다', async () => {
            ...
            const wrapper: ReturnType<typeof mountComponent> = mount(VsSwitch);
            // when
            await wrapper.find('[role="switch"]').trigger('blur');
            // then
